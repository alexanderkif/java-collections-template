...
public class SimpleTextStatisticsAnalyzer implements TextStatisticsAnalyzer {
    ...
    public Map<String, Integer> countNumberOfWordsRepetitions(String text) {
        Map<String, Integer> includeWordsCount = new HashMap<>();
        for (String word : getWords(text)) {
            includeWordsCount.merge(word, 1, Integer::sum);
        }
        return includeWordsCount;
    }
    ...
    public List<String> sortWordsByLength(String text, Direction direction) {
        ...
        words.sort(direction.equals(Direction.ASC)
